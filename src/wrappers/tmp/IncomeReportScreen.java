...
public class IncomeReportScreen extends SceneBase {
	...
	public void initialize() throws Exception {
		...
		fuelingPurchase.setStation(station);
		...
		MfText totalPriceControlBenzinTotal_price = new MfText((Text) _scene.lookup("#table$station_manager_reports$station$fueling_purchase$fuel_enum$$$benzin$total_price"));
		MfText totalPriceControlSolerTotal_price = new MfText((Text) _scene.lookup("#table$station_manager_reports$station$fueling_purchase$fuel_enum$$$soler$total_price"));
		MfText totalPriceControlMotorcycleTotal_price = new MfText((Text) _scene.lookup("#table$station_manager_reports$station$fueling_purchase$fuel_enum$$$motorcycle$total_price"));
