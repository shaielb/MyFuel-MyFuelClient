...
@AutoGenerated
public class CompanyManagerExpenseReportScreen extends StationReportsBase {

	private static String  ReportType = "Expanse Report";
	...
	public CompanyManagerExpenseReportScreen(ISceneSwitcher sceneSwitcher, IClient client, Context context) throws Exception {
		super(sceneSwitcher, client, context);
	}

	@Override
	public void initialize() throws Exception {
		Parent root = FXMLLoader.load(Main.class.getResource("CompanyManagerExpenseReportScreen.fxml"));
