...
public class SignUpPaymentDetailsScreen extends SceneBase {
	...
	private MfImageView _creditCardNumberControlMc;
	private MfImageView _creditCardNumberControlV;
	...
	public void initialize() throws Exception {
		...
		_signUpAddCarScreenControl.addEvent((event) -> { 
		...
		_creditCardNumberControlMc = new MfImageView((ImageView) _scene.lookup("#table$customer$payment$credit_card_number$$$mc"));
		_creditCardNumberControlV = new MfImageView((ImageView) _scene.lookup("#table$customer$payment$credit_card_number$$$v"));
		...
		_creditCardNumberControlAe.setField(_payment.getClass().getDeclaredField("_credit_card_number"));
		_creditCardNumberControlAe.setEntity(_payment);
		...
		_creditCardNumberControlMc.setField(_payment.getClass().getDeclaredField("_credit_card_number"));
		_creditCardNumberControlMc.setEntity(_payment);

		_creditCardNumberControlV.setField(_payment.getClass().getDeclaredField("_credit_card_number"));
		_creditCardNumberControlV.setEntity(_payment);

		//grouping
		groupControls(new ControlAdapter[] { _creditCardNumberControl, _creditCardNumberControlAe, _creditCardNumberControlMc, _creditCardNumberControlV });
		...
		try {
			...
			responseEvent.continueWith((response) -> {
				if (response.isPassed()) {
					...
					_switcher.switchScene("SignUpPersonalDetailsScreen");
				}
			});
		} catch (IOException e) {
			e.printStackTrace();
